 ...
 * It should: have two parameters: earthWeight and planet
 * expect earthWeight to be a number expect planet to be a string
 ...
 * For all other inputs, return 'Invalid Planet Entry. Try: Mercury, 
 * Venus, Mars, Jupiter, or Saturn.'
 * For this problem, you may choose to use either a switch or multiple if's. 
